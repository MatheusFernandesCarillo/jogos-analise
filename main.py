...
db = pd.read_csv('https://raw.githubusercontent.com/MatheusFernandesCarillo/games_datascience_study/refs/heads/main/Video_Games_Sales_as_at_22_Dec_2016.csv')
