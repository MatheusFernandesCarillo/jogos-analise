...
#grafico mostrando a quantidade de jogos por plataforma, somados
...
#grafico interativ, mostrando a quantidade de jogos por plataforma, ano a ano
fig = px.line(db_plataforma_ano, x=' Ano de Lançamento', y='Quantidade de Jogos', color='Plataforma', title='Comparação de Plataformas ao Longo dos Anos')
